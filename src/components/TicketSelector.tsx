...
const ticketOptions: TicketOption[] = [
  {
    id: 'backstage',
    name: 'PRÉ VENDA - CAMAROTE',
    price: 197.00,
    checkoutUrl: 'https://seguro.compras-segurasoficial.shop/api/public/shopify?product=1965183733328&store=19651'
  },
  {
    id: 'frontstage',
    name: 'PRÉ VENDA - FRONTSTAGE',
    price: 97.00,
    checkoutUrl: 'https://seguro.compras-segurasoficial.shop/api/public/shopify?product=1965189944591&store=19651'
  }
];
