        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              SambaVR - Especial Dia dos Namorados
            </h1>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold">06 jun - 2026 - 17:00 &gt; 07 jun - 2026 - 01:00</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold">Evento presencial em <span className="text-blue-400">Área Verde da Pet, Volta Redonda - RJ</span></p>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              <img
                ...
                alt="SAMBAVRÓ - Especial Dia dos Namorados"
